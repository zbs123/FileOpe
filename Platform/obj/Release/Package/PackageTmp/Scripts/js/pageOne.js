...
$(function () {
    ...
    $("#typelist li").off().on("click", function () {
        ...
        if (dd == '0') {
            $(".export-save").attr("href", "/home/picture?token=" + token);
            $("#sp").trigger("click");
        }
        if (dd == '1') {
            $(".export-save").attr("href", "/home/pageone?type=2&token=" + token);
            $("#sp").trigger("click");
        }
        if (dd == '2') {
            $(".export-save").attr("href", "/home/pageone?type=0&token=" + token);
            $("#sp").trigger("click");
        }
    })
